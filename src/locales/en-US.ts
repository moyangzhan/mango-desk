export default {
  ...
  indexer: {
    ...
    changeConfirmFile: 'Parsed content of {count} indexed files will be saved as .md files',
    changeConfirmDatabase: 'Parsed content of {count} indexed files will be stored in database',
    changeConfirmNone: 'Parsed content of {count} indexed files will be deleted, preview will be unavailable',
    changeConfirmReparse: '{count} files need to be re-parsed to recover content, this may take some time',
    changing: 'Changing...',
